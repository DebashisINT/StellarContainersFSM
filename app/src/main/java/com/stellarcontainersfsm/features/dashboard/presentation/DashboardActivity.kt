package com.stellarcontainersfsm.features.dashboard.presentation
...
import com.stellarcontainersfsm.*
import com.stellarcontainersfsm.R
import com.stellarcontainersfsm.app.*
import com.stellarcontainersfsm.app.NewFileUtils.browseDocuments
import com.stellarcontainersfsm.app.NewFileUtils.browsePDFDocuments
import com.stellarcontainersfsm.app.NewFileUtils.getExtension
import com.stellarcontainersfsm.app.domain.*
import com.stellarcontainersfsm.app.types.DashboardType
import com.stellarcontainersfsm.app.types.FragType
import com.stellarcontainersfsm.app.types.TopBarConfig
import com.stellarcontainersfsm.app.uiaction.DisplayAlert
import com.stellarcontainersfsm.app.utils.*
import com.stellarcontainersfsm.app.utils.AppUtils.Companion.isProfile
import com.stellarcontainersfsm.base.BaseResponse
import com.stellarcontainersfsm.base.presentation.BaseActivity
import com.stellarcontainersfsm.base.presentation.BaseFragment
import com.stellarcontainersfsm.features.NewQuotation.*
import com.stellarcontainersfsm.features.NewQuotation.api.GetQuotRegProvider
import com.stellarcontainersfsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.stellarcontainersfsm.features.SearchLocation.SearchLocationFragment
import com.stellarcontainersfsm.features.SearchLocation.locationInfoModel
import com.stellarcontainersfsm.features.TA.ViewAllTAListFragment
import com.stellarcontainersfsm.features.achievement.AchievementFragment
import com.stellarcontainersfsm.features.activities.presentation.*
import com.stellarcontainersfsm.features.addAttendence.*
import com.stellarcontainersfsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.stellarcontainersfsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.stellarcontainersfsm.features.addAttendence.model.GetReportToFCMResponse
import com.stellarcontainersfsm.features.addAttendence.model.GetReportToResponse
import com.stellarcontainersfsm.features.addAttendence.model.Leave_list_Response
import com.stellarcontainersfsm.features.addorder.presentation.AddOrderFragment
...
import com.stellarcontainersfsm.features.addshop.presentation.AddShopFragment
import com.stellarcontainersfsm.features.addshop.presentation.OTPVerificationDialog
import com.stellarcontainersfsm.features.addshop.presentation.ScanImageFragment
import com.stellarcontainersfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.stellarcontainersfsm.features.alarm.model.AlarmData
import com.stellarcontainersfsm.features.alarm.presetation.AttendanceReportFragment
import com.stellarcontainersfsm.features.alarm.presetation.PerformanceReportFragment
import com.stellarcontainersfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.stellarcontainersfsm.features.alarm.presetation.VisitReportFragment
import com.stellarcontainersfsm.features.attendance.AttendanceFragment
import com.stellarcontainersfsm.features.attendance.api.AttendanceRepositoryProvider
import com.stellarcontainersfsm.features.attendance.model.AttendanceRequest
import com.stellarcontainersfsm.features.attendance.model.AttendanceResponse
import com.stellarcontainersfsm.features.averageshop.presentation.AverageShopFragment
import com.stellarcontainersfsm.features.avgorder.presentation.AverageOrderFragment
import com.stellarcontainersfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.stellarcontainersfsm.features.beatCustom.TeamBeatListFragment
import com.stellarcontainersfsm.features.billing.presentation.AddBillingFragment
import com.stellarcontainersfsm.features.billing.presentation.BillingDetailsFragment
import com.stellarcontainersfsm.features.billing.presentation.BillingListFragment
import com.stellarcontainersfsm.features.changepassword.presentation.ChangePasswordDialog
import com.stellarcontainersfsm.features.chat.model.ChatListDataModel
import com.stellarcontainersfsm.features.chat.model.ChatUserDataModel
import com.stellarcontainersfsm.features.chat.model.GroupUserDataModel
import com.stellarcontainersfsm.features.chat.presentation.*
import com.stellarcontainersfsm.features.chatbot.presentation.ChatBotFragment
import com.stellarcontainersfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.stellarcontainersfsm.features.chatbot.presentation.ReportsFragment
import com.stellarcontainersfsm.features.chatbot.presentation.SelectLanguageDialog
import com.stellarcontainersfsm.features.commondialog.presentation.CommonDialog
import com.stellarcontainersfsm.features.commondialog.presentation.CommonDialogClickListener
import com.stellarcontainersfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.stellarcontainersfsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.stellarcontainersfsm.features.commondialogsinglebtn.OnDialogClickListener
import com.stellarcontainersfsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.stellarcontainersfsm.features.contacts.ContactDtls
import com.stellarcontainersfsm.features.contacts.ContactGr
import com.stellarcontainersfsm.features.contacts.ContactsAddFrag
import com.stellarcontainersfsm.features.contacts.ContactsFrag
import com.stellarcontainersfsm.features.contacts.SchedulerViewFrag
import com.stellarcontainersfsm.features.contacts.SchedulerAddFormFrag
import com.stellarcontainersfsm.features.contacts.TemplateAddFrag
import com.stellarcontainersfsm.features.contacts.TemplateViewFrag
import com.stellarcontainersfsm.features.dailyPlan.prsentation.AllShopListFragment
import com.stellarcontainersfsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.stellarcontainersfsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.stellarcontainersfsm.features.damageProduct.ShopDamageProductListFrag
import com.stellarcontainersfsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.stellarcontainersfsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.stellarcontainersfsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.stellarcontainersfsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.stellarcontainersfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.stellarcontainersfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.stellarcontainersfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.stellarcontainersfsm.features.dashboard.presentation.model.ContentListResponseModel
import com.stellarcontainersfsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.stellarcontainersfsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.stellarcontainersfsm.features.device_info.presentation.DeviceInfoListFragment
import com.stellarcontainersfsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.stellarcontainersfsm.features.document.DocumentRepoFeatureNewFragment
import com.stellarcontainersfsm.features.document.presentation.DocumentListFragment
import com.stellarcontainersfsm.features.document.presentation.DocumentTypeListFragment
import com.stellarcontainersfsm.features.document.presentation.OpenFileWebViewFragment
import com.stellarcontainersfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.stellarcontainersfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.stellarcontainersfsm.features.dymanicSection.presentation.DynamicListFragment
import com.stellarcontainersfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.stellarcontainersfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.stellarcontainersfsm.features.home.presentation.HomeFragment
import com.stellarcontainersfsm.features.homelocation.presentation.HomeLocationFragment
import com.stellarcontainersfsm.features.homelocation.presentation.HomeLocationMapFragment
import com.stellarcontainersfsm.features.know_your_state.KnowYourStateFragment
import com.stellarcontainersfsm.features.lead.LeadFrag
import com.stellarcontainersfsm.features.lead.ViewLeadFrag
import com.stellarcontainersfsm.features.leaveapplynew.LeaveHome
import com.stellarcontainersfsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.stellarcontainersfsm.features.localshops.LocalShopListFragment
import com.stellarcontainersfsm.features.localshops.LocalShopListMapFragment
import com.stellarcontainersfsm.features.localshops.NearByShopsMapFragment
import com.stellarcontainersfsm.features.location.*
import com.stellarcontainersfsm.features.location.api.LocationRepoProvider
import com.stellarcontainersfsm.features.location.model.*
import com.stellarcontainersfsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.stellarcontainersfsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.stellarcontainersfsm.features.login.ShopFeedbackEntity
import com.stellarcontainersfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.stellarcontainersfsm.features.login.presentation.LoginActivity
import com.stellarcontainersfsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.stellarcontainersfsm.features.logoutsync.presentation.LogoutSyncFragment
import com.stellarcontainersfsm.features.marketAssist.MarketAssistTabFrag
import com.stellarcontainersfsm.features.marketAssist.ShopDtlsMarketAssistFrag
import com.stellarcontainersfsm.features.marketAssist.ShopListMarketAssistFrag
import com.stellarcontainersfsm.features.marketing.presentation.MarketingPagerFragment
import com.stellarcontainersfsm.features.meetinglist.prsentation.MeetingListFragment
import com.stellarcontainersfsm.features.member.MapViewForTeamFrag
import com.stellarcontainersfsm.features.member.model.TeamLocDataModel
import com.stellarcontainersfsm.features.member.model.TeamShopListDataModel
import com.stellarcontainersfsm.features.member.presentation.*
import com.stellarcontainersfsm.features.menuBeat.MenuBeatFrag
import com.stellarcontainersfsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.stellarcontainersfsm.features.micro_learning.presentation.MicroLearningListFragment
import com.stellarcontainersfsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.stellarcontainersfsm.features.myallowancerequest.MyallowanceRequestFragment
import com.stellarcontainersfsm.features.myjobs.model.CustomerDataModel
import com.stellarcontainersfsm.features.myjobs.presentation.*
import com.stellarcontainersfsm.features.myorder.presentation.MyOrderListFragment
import com.stellarcontainersfsm.features.myprofile.presentation.MyProfileFragment
import com.stellarcontainersfsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.stellarcontainersfsm.features.nearbyshops.model.ShopData
import com.stellarcontainersfsm.features.nearbyshops.model.ShopListResponse
import com.stellarcontainersfsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.stellarcontainersfsm.features.nearbyshops.presentation.BeatListFragment
import com.stellarcontainersfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.stellarcontainersfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.stellarcontainersfsm.features.nearbyshops.presentation.ShopCallHisFrag
import com.stellarcontainersfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.stellarcontainersfsm.features.newcollection.CollectionDetailsStatusFragment
import com.stellarcontainersfsm.features.newcollection.CollectionShopListFragment
import com.stellarcontainersfsm.features.newcollection.NewCollectionListFragment
import com.stellarcontainersfsm.features.newcollectionreport.*
import com.stellarcontainersfsm.features.notification.NotificationFragment
import com.stellarcontainersfsm.features.orderList.NewDateWiseOrderListFragment
import com.stellarcontainersfsm.features.orderList.NewOrderListFragment
import com.stellarcontainersfsm.features.orderList.OrderListFragment
import com.stellarcontainersfsm.features.orderdetail.presentation.OrderDetailFragment
import com.stellarcontainersfsm.features.orderhistory.ActivityMapFragment
import com.stellarcontainersfsm.features.orderhistory.OrderhistoryFragment
import com.stellarcontainersfsm.features.orderhistory.TimeLineFragment
import com.stellarcontainersfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.stellarcontainersfsm.features.orderhistory.model.LocationData
import com.stellarcontainersfsm.features.pendinglocationinout.PendingOutLocationFrag
import com.stellarcontainersfsm.features.performance.GpsStatusFragment
import com.stellarcontainersfsm.features.performance.PerformanceFragment
import com.stellarcontainersfsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.stellarcontainersfsm.features.performance.model.UpdateGpsInputParamsModel
import com.stellarcontainersfsm.features.performanceAPP.OwnPerformanceFragment
import com.stellarcontainersfsm.features.performanceAPP.PerformanceAppFragment
import com.stellarcontainersfsm.features.performanceAPP.allPerformanceFrag
import com.stellarcontainersfsm.features.permissionList.ViewPermissionFragment
import com.stellarcontainersfsm.features.photoReg.*
import com.stellarcontainersfsm.features.privacypolicy.PrivacypolicyWebviewFrag
import com.stellarcontainersfsm.features.quotation.presentation.*
import com.stellarcontainersfsm.features.reimbursement.presentation.*
import com.stellarcontainersfsm.features.report.presentation.*
import com.stellarcontainersfsm.features.returnsOrder.*
import com.stellarcontainersfsm.features.settings.presentation.SettingsFragment
import com.stellarcontainersfsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.stellarcontainersfsm.features.shopdetail.presentation.*
import com.stellarcontainersfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.stellarcontainersfsm.features.stock.StockDetailsFragment
import com.stellarcontainersfsm.features.stock.StockListFragment
import com.stellarcontainersfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.stellarcontainersfsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.stellarcontainersfsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.stellarcontainersfsm.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.stellarcontainersfsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.stellarcontainersfsm.features.stockCompetetorStock.CompetetorStockFragment
import com.stellarcontainersfsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.stellarcontainersfsm.features.survey.SurveyFrag
import com.stellarcontainersfsm.features.survey.SurveyViewDtlsFrag
import com.stellarcontainersfsm.features.survey.SurveyViewFrag
import com.stellarcontainersfsm.features.task.presentation.AddTaskFragment
import com.stellarcontainersfsm.features.task.presentation.CalenderTaskFragment
import com.stellarcontainersfsm.features.task.presentation.EditTaskFragment
import com.stellarcontainersfsm.features.task.presentation.TaskListFragment
import com.stellarcontainersfsm.features.taskManagement.TaskManagementFrag
import com.stellarcontainersfsm.features.taskManagement.ViewTaskManagementFrag
import com.stellarcontainersfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.stellarcontainersfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.stellarcontainersfsm.features.timesheet.presentation.TimeSheetListFragment
import com.stellarcontainersfsm.features.viewAllOrder.CartFragment
import com.stellarcontainersfsm.features.viewAllOrder.OrderTypeListFragment
import com.stellarcontainersfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.stellarcontainersfsm.features.viewAllOrder.ViewCartFragment
import com.stellarcontainersfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.stellarcontainersfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.stellarcontainersfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.stellarcontainersfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.stellarcontainersfsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.stellarcontainersfsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.stellarcontainersfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.stellarcontainersfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.stellarcontainersfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.stellarcontainersfsm.features.viewPPDDStock.ViewStockFragment
import com.stellarcontainersfsm.features.weather.presentation.WeatherFragment
import com.stellarcontainersfsm.mappackage.MapActivity
import com.stellarcontainersfsm.mappackage.MapActivityWithoutPath
import com.stellarcontainersfsm.mappackage.SendBrod
import com.stellarcontainersfsm.widgets.AppCustomEditText
import com.stellarcontainersfsm.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xstellarcontainersfsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xstellarcontainersfsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.stellarcontainersfsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xstellarcontainersfsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xstellarcontainersfsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xstellarcontainersfsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xstellarcontainersfsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
