package com.stellarcontainersfsm.features.logoutsync.presentation
...
import com.stellarcontainersfsm.app.AppDatabase
import com.stellarcontainersfsm.app.NetworkConstant
...
import com.stellarcontainersfsm.app.utils.AppUtils
import com.stellarcontainersfsm.app.utils.Toaster
import com.stellarcontainersfsm.base.BaseResponse
import com.stellarcontainersfsm.base.presentation.BaseActivity
import com.stellarcontainersfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.stellarcontainersfsm.features.billing.api.AddBillingRepoProvider
import com.stellarcontainersfsm.features.billing.model.AddBillingInputParamsModel
...
import com.stellarcontainersfsm.features.dashboard.presentation.ReasonDialog
...
import com.stellarcontainersfsm.features.document.model.AddEditDocumentInputParams
import com.stellarcontainersfsm.features.document.model.DocumentAttachmentModel
...
import com.stellarcontainersfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.stellarcontainersfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.stellarcontainersfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.stellarcontainersfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.stellarcontainersfsm.features.orderhistory.model.*
...
import com.stellarcontainersfsm.features.quotation.model.AddQuotInputModel
import com.stellarcontainersfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.stellarcontainersfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.stellarcontainersfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.stellarcontainersfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.stellarcontainersfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.stellarcontainersfsm.features.timesheet.model.AddTimeSheetInputModel
import com.stellarcontainersfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.stellarcontainersfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.stellarcontainersfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.stellarcontainersfsm.mappackage.SendBrod
import com.stellarcontainersfsm.widgets.AppCustomTextView
import com.stellarcontainersfsm.MonitorService
import com.stellarcontainersfsm.MySingleton
...
import com.stellarcontainersfsm.features.addshop.presentation.ShopExtraContactReq
...
import com.stellarcontainersfsm.features.login.model.GetConcurrentUserResponse
import com.stellarcontainersfsm.features.login.model.WhatsappApiData
import com.stellarcontainersfsm.features.performance.model.Gps_status_list
import com.stellarcontainersfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.stellarcontainersfsm.features.returnsOrder.ReturnProductList
import com.stellarcontainersfsm.features.returnsOrder.ReturnRequest
import com.stellarcontainersfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xstellarcontainersfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xstellarcontainersfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xstellarcontainersfsmlogsample/log.zip").path);
